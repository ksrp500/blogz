...
def signup():
    if request.method == 'POST':
        ...
        if password != verify:                                  #check for password error
        ...
        return render_template('signup.html', header='Signup', length_error=length_error, 
                password_error=password_error, user_error=user_error)   #check for user, password error
